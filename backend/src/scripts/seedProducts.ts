  ...
  try {
    ...
    const products = [
      ...
      },
      {
        ...
        weightUnit: "capsules",
        images: [
          "https://images.unsplash.com/photo-1584308666744-24d5f400f6f1?w=400"
        ],
        description: "Cognitive support supplement",
        benefits: ["Brain health", "Focus", "Memory", "Mental clarity"],
        tags: ["supplement", "cognitive", "health"],
        stock: 80,
        isFeatured: true,
        isActive: true
      },
